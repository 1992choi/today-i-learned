...
## 객체지향의 4대 특징
- 캡슐화
  - 관련된 기능과 데이터를 하나의 클래스로 묶어서 사용할 수 있으며, 이를 통해 정보은닉 효과를 얻을 수 있다.
- 상속성
...
- 팩토리 메서드 패턴의 장점
  ...
  - 유연성과 확장성
    ...
    - 기존의 코드를 수정하지 않고 확장이 가능하여, 개방 폐쇄 원칙(Open-Closed Principle, OCP)을 위반하지 않는다.
  - 의존성 관리
...
- 템플릿 메서드 패턴의 단점
  - 상위 클래스 변화가 생길 경우, 모든 하위 클래스를 수정해야할 수도 있다.
