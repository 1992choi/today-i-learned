...
### Java의 특징
> -객체지향 프로그래밍 언어   
> -JVM에 의해 운영체제 없이 독립적으로 작동하므로 이식성이 높음   
> -객체지향 개념의 특징인 캡슐화, 상속, 다형성이 잘 적용된 언어   
> -Garbage Collector에 의해 자동적인 메모리 관리 가능   
> -멀티쓰레드 지원     

### 객체지향 프로그래밍의 특징
> -객체지향 프로그래밍(Object-Oriented Programming, OOP) : 객체를 기반으로 프로그래밍을 하는 프로그래밍스타일 혹은 패러다임
> - **캡슐화**   
